...
class AliExpressLibrary {
    ...
    async getData(id) {
        ...
        const payload = {
            ...
            source_values: `https://ar.aliexpress.com/i/${id}.html,https://star.aliexpress.com/share/share.htm?redirectUrl=https%3A%2F%2Fvi.aliexpress.com%2Fitem%2F${id}.html%3FsourceType%3D620%26channel%3Dcoin&aff_fcid=,https://ar.aliexpress.com/i/${id}.html?sourceType=562&aff_fcid=,https://ar.aliexpress.com/i/${id}.html?sourceType=561&aff_fcid=`,
        };
